...
req = Request('http://localhost:8000/graphql', data=json.dumps({
  'query': 'query GetDashboardMetrics($startDate: String!, $endDate: String!) { dashboardMetrics(startDate: $startDate, endDate: $endDate) { summary { mrr churnRate } timeline { date mrrValue } } }', 
